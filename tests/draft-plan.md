...
1. Convert EAP from a coding-agent runtime concept into a general environment awareness protocol.
2. Define unambiguous core objects, parameters, lifecycle states, delivery actions, and rule semantics.
3. Align the agent binding with current MCP and A2A development patterns without making EAP depend on either protocol.
...
- Use EAP version `0.2.0-draft` throughout the package.
